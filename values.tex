...
% Seed valuation multiple on raise (typical: 25-30x for promising marketplaces)
\newcommand{\seedRaiseMultiple}{28.5}

% Seed pre-money valuation (USD).
% Calculated as raise amount × multiple (pre-revenue marketplace standard)
\newcommand{\seedValuation}{\fpeval{\seedAmount * \seedRaiseMultiple}}
