...
% Calculate the raw breakeven month
\newcommand{\breakevenMonthRaw}{\fpeval{(2 * \monthlyBurnYearOne) / (\subsPerMonth * \monthlyRevPerSub) - 1}}

% Round and cap the result
\newcommand{\breakevenMonth}{\fpeval{round(min(max(\breakevenMonthRaw, 12), 36), 0)}}

% Calculate subscribers at breakeven - ensure not zero
\newcommand{\breakevenSubscribersRaw}{\fpeval{\breakevenMonth * \subsPerMonth}}
