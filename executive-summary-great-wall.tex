...
Providers (Patrick) are directly incentivized to attract clients (Charlie) as more demand means more computation jobs. This creates a powerful viral marketing dynamic:
\begin{itemize}
  \item Each provider attracts ~\num{\providerViralCoeff} new clients through word-of-mouth
  \item Providers promote the platform to monetize their idle capacity
  \item Network effect compounds with \num{\viralGrowthFactor}x annual growth factor
\end{itemize}
...
\begin{tabularx}{\linewidth}{l Y Y Y}
\toprule
Year & Base CAC & Viral Reduction & Effective CAC \\\midrule
...
\begin{enumerate}
  ...
  \item \textbf{Viral Growth Engine:} Providers incentivized to attract clients, reducing CAC by \num{\cacViralReductionYearThree}\% by Year 3
\end{enumerate}
