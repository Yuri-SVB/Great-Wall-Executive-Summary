...
\begin{itemize}
  ...
  \item Tiers differentiate by computation duration: 2, 24, 48, 168, and 336 hours
\end{itemize}
...
\toprule
Tier & Hours & Price (/mo) & Mix (\%) & Patrick Cost/mo & Markup \\\midrule
Basic   & 2 & \num{\subBasicPrice}  & \num{\subBasicMix} & \num{0.36} & 7.2x \\
Medium  & 24 & \num{\subMediumPrice} & \num{\subMediumMix} & \num{4.32} & 6.9x \\
Professional & 48 & \num{\subProfessionalPrice} & \num{\subProfessionalMix} & \num{8.64} & 10.4x \\
Golden  & 168 & \num{\subGoldenPrice} & \num{\subGoldenMix} & \num{30.24} & 7.3x \\
Platinum & 336 & \num{\subPlatinumPrice} & \num{\subPlatinumMix} & \num{60.40} & 7.3x \\\midrule
\textbf{Weighted Avg} &  &  & \textbf{\num{100}} &  &  \\
\bottomrule
\end{tabularx}
\end{table}
\textit{Note: Patrick's costs based on 350W @ \$0.12/kWh, 4.28 runs/month. Markup includes Patrick's margin (2.5-3x) + Mark's platform fee (25-30\%)}

\subsection{Marketplace Economics Justification}
The pricing structure reflects:
\begin{itemize}
  \item \textbf{Patrick's Markup (2.5-3x):} Covers electricity, wear, bandwidth, opportunity cost, and risk premium for anonymous transactions
  \item \textbf{Mark's Platform Fee (25-30\%):} Funds anonymous matchmaking infrastructure, reputation system maintenance, dispute resolution, and first-mover advantage consolidation
  \item \textbf{Non-linear Pricing:} Professional tier premium reflects scarcity of providers willing to commit 48-hour blocks
\end{itemize}
...
\begin{itemize}
  ...
  \item Months 1-3: Build anonymous matchmaking infrastructure and reputation system
  \item Months 4-6: Launch beta, acquire first \numint{\betaUsers} users
  \item Months 7-12: Scale marketplace, prove unit economics
