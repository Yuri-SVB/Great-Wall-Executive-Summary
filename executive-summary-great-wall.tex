...
% Centralized values
\input{values/costs.tex}
\input{values/patrick.tex}
\input{values/subscription-stats.tex}
\input{values/hardware-values.tex}
\input{values/merch-values.tex}
\input{values/costumer-stats.tex}
\input{values.tex}
