...
\end{tabularx}
\end{table}
\textit{Note: Merchandise sales offset CAC but are not counted as revenue}
...
\end{tabularx}
\end{table}
\textit{Note: Merchandise improves unit economics through CAC reduction but is not counted as revenue}
...
\end{tabularx}
\end{table}
\textit{Note: Merchandise sales (60\% attach rate, \$13.44 profit) reduce effective CAC}
