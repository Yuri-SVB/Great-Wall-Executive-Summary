...
Hardware Revenue & 1.5x & 0 & 532,500 & 1,065,000 \\
Merchandise Revenue & 0.5x & 25,200 & 49,140 & 72,800 \\\midrule
\textbf{Total Valuation} &  & \textbf{17,139,600} & \textbf{34,810,440} & \textbf{52,481,000} \\
\bottomrule
\end{tabularx}
\end{table}
\textit{Note: Using conservative multiples appropriate for early-stage company}
