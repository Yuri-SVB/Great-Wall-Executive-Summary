...
\begin{titlepage}
    ...
    \highlightednumber{117.6M}{Year 5 Revenue Projection}
    
    \vspace{1cm}
    
    \begin{minipage}[t]{0.3\textwidth}
        \metriccard{7.5B}{Target Market}{Serviceable Obtainable Market}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.3\textwidth}
        \metriccard{85\%}{Gross Margin}{Year 5 Target}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.3\textwidth}
        \metriccard{14:1}{LTV:CAC}{Customer Economics}
    \end{minipage}
